...
interface ObjectListInterface {
     ...
     *
     * Be aware that when adding an item with an id flag, if an existing item
     * with the same id is present the method will fail and return FALSE.
     *
     * @param mixed $item
     *
     * @return $this
     ...
     * @param  bool            $add_if_not_found Set this to false to avoid
     *                                           having items that can't be
     *                                           replaced, added.
     *
     * @return int
     *   - 0: method failed
     ...
     *
     * @param  mixed $id Optional. Omit to return all items.  Otherwise all
     *                   items having this id will be returned.
     *
     * @return array
